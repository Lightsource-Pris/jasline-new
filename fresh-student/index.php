...
<head>
    ...
    <link rel="stylesheet" href="../css/bg/fresh-bg.css">
...
<body>
        ...
        <div class="collapse navbar-collapse side-nav" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href=""><i class="fa fa-street-view" aria-hidden="true"></i>Fresh
                        Students </a>
                </li>
                <li class="nav-item">
    ...
    <div class="hero-image">
        <div class="hero-text wow animated fadeInUp">
            ...
            <p class="hero-p">Fresh Students Category</p>
    ...
    <div class="cat-descrpt row">
        <div class="desc-illustration col-lg-6 wow animated fadeInLeft">
            <img src="../img/stand.svg" alt="" class="desc-img img-fluid">
        </div>
        <div class="desc-text col-lg-6 wow animated fadeInRight">
            ...
            To those that tried not to be overwhelmed by the ocean of activities and school engagements on getting to the campus. <br>
    ...
    <div class="vote-div">
        ...
        ?>
            <div class="vote-box wow animated fadeInDown">
                ...
                <h4 class="vote-title">Rookie of The Year - Male</h4>
                <?php
                    while($row = $rotym->fetch_array()){
                        $name = $row['name'];
                ?>
                <div class="form-check">
                    <label class="form-check-label" for="mostPM1">
                        <input required type="radio" class="form-check-input" id="mostPM1" name="Rookie_of_the_year_M" value="<?php echo $name?>"
                        ><?php echo $name?>
                    </label>
                </div>
                <?php
            ...
            <div class="vote-box wow animated fadeInDown">
                <h4 class="vote-title">Rookie of The Year - Female</h4>
                <?php
                    while($row = $rotyf->fetch_array()){
                        $name = $row['name'];
                ?>
                <div class="form-check">
                    <label class="form-check-label" for="mostPM1">
                        <input required type="radio" class="form-check-input" id="mostPM1" name="Rookie_of_the_year_F" value="<?php echo $name?>"
                        ><?php echo $name?>
                    </label>
                </div>
                <?php
            ...
            <div class="vote-box wow animated fadeInDown">
                <h4 class="vote-title">Best New Student - Male</h4>
                <?php
                    while($row = $bnsm->fetch_array()){
                        $name = $row['name'];
                ?>
                <div class="form-check">
                    <label class="form-check-label" for="mostPM1">
                        <input required type="radio" class="form-check-input" id="mostPM1" name="Best_new_student_M" value="<?php echo $name?>"
                        ><?php echo $name?>
                    </label>
                </div>
                <?php
            ...
            <div class="vote-box wow animated fadeInDown">
                <h4 class="vote-title">Best New Student - Female</h4>
                <?php
                    while($row = $bnsf->fetch_array()){
                        $name = $row['name'];
                ?>
                <div class="form-check">
                    <label class="form-check-label" for="mostPM1">
                        <input required type="radio" class="form-check-input" id="mostPM1" name="Best_new_student_F" value="<?php echo $name?>"
                        ><?php echo $name?>
                    </label>
                </div>
                <?php
            ...
            <div class="vote-box wow animated fadeInDown">
                <h4 class="vote-title">Next Rated</h4>
                <?php
                    while($row = $nra->fetch_array()){
                        $name = $row['name'];
                ?>
                <div class="form-check">
                    <label class="form-check-label" for="mostPM1">
                        <input required type="radio" class="form-check-input" id="mostPM1" name="Next_rated_artist" value="<?php echo $name?>"
                        ><?php echo $name?>
                    </label>
                </div>
                <?php

        ...
        <nav class="navbar navbar-default d-lg-none size-14">
            ...
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav mt-5 pl-3">
                    ...
                    <li class="mb-3 add pt-3"><a class="pl-4 act" href=""><img class="mr-3 share_icon view_icon my_icon" src="../img/view-details_white.svg" alt="Icon">View Nominees</a></li>
                    ...
                    <li class="pt-3 mt-5 pt-5" id="logout1"><a class="pl-4 logout"></a><img class="mr-3" src="../img/logout_icon.svg" alt="Icon">Logout</a></li>
                </ul>
            ...
            <div class="col-lg-9 col-md-12 mt-3 body">
                <div class="row publicize pb-5">
                    ...
                    <div class="col-12 col-lg-5 vote-card nomi-count mt-3 mt-lg-0">
                      ...
                      <h3 class="ml-lg-3 mt-4 col-12">Nominees and Votes</h3> 
                      <div class="table-responsive col-12">
                        ...
                        <tbody>
                        <?php
                          while ($row = $new_get_order->fetch_array()){
                            $id = $row['id'];
                            $name = $row['name'];

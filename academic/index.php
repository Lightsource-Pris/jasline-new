...
<head>
    ...
    <link rel="stylesheet" href="../css/bg/acad-bg.css">
...
<body>
        ...
        <div class="collapse navbar-collapse side-nav" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href=""><i class="fa fa-book"></i>Academics <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
    ...
    <div class="hero-image">
        <div class="hero-text wow animated fadeInUp">
            ...
            <p class="hero-p">Academics Category</p>
    ...
    <div class="cat-descrpt row">
        <div class="desc-illustration col-lg-6 wow animated fadeInLeft">
            <img src="../img/acad.svg" alt="" class="desc-img img-fluid">
        </div>
    ...
    <div class="vote-div">
        ...
        ?>
            <div class="vote-box">
                <h2 class="vote-title">Best Student Academics</h2>
                <?php
                    while($row = $bsa->fetch_array()){
                        $name = $row['name'];
                ?>
                <div class="form-check">
                    <label class="form-check-label" for="mostPM1">
                        <input required type="radio" class="form-check-input" id="mostPM1" name="Best_Student_Academics" value="<?php echo $name?>"
                        ><?php echo $name?>
                    </label>
                </div>
                <?php
            ...
            <div class="vote-box">
                <h2 class="vote-title">Best Honorable</h2>
                <?php
                    while($row = $bh->fetch_array()){
                        $name = $row['name'];
                ?>
                <div class="form-check">
                    <label class="form-check-label" for="mostPM1">
                        <input required type="radio" class="form-check-input" id="mostPM1" name="Best_Honorable" value="<?php echo $name?>"
                        ><?php echo $name?>
                    </label>
                </div>
                <?php
        ...
        <input type="submit" class="btn btn-info" value="Submit" name="vote">
        </form>
    </div>
